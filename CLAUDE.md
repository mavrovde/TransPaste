...
- Key-absence tests auto-skip when the matching env var (`GEMINI_API_KEY`/`OPENAI_API_KEY`) is set in the environment — a "Skipped" line in test output is expected, not a failure.
